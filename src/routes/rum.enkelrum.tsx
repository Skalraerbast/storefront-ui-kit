...
export const Route = createFileRoute("/rum/enkelrum")({
  head: () => ({
    meta: [
      { title: "Enkelrum — Lilla Hotellet i Lund" },
      {
        name: "description",
        content:
          "Boka Enkelrum på Lilla Hotellet i Lund. Personligt krypin med eget badrum, skrivbord, Wi-Fi och frukostbuffé.",
      },
      { property: "og:title", content: "Enkelrum — Lilla Hotellet" },
      {
        property: "og:description",
        content: "Ditt personliga krypin mitt i Lund.",
      },
    ],
  }),
  component: EnkelrumPage,
});

const IMAGES = [
  { src: "/assets/rooms/enkelrum-1.svg", alt: "Enkelrum Lilla Hotellet bild 1" },
  { src: "/assets/rooms/enkelrum-2.svg", alt: "Enkelrum Lilla Hotellet bild 2" },
];
      ...
      >
        <div className="mx-auto max-w-[1000px]">
          ...
          <p className="mb-10 mt-2 text-center text-lg font-bold uppercase tracking-[2px] text-[#c5a982]">
            Ditt personliga krypin mitt i Lund
          </p>
          ...
          <div className="mb-16 grid grid-cols-1 gap-[50px] md:grid-cols-[2fr_1fr]">
            <div>
              <h2 className="mb-5 font-serif text-[28px] text-[#2b2725]">
                Bo smart och bekvämt
              </h2>
              <p className="mb-5 text-base leading-[1.7] text-[#4a443f]">
                Reser du ensam? Njut av lugnet i våra personliga enkelrum. Här
                kombineras 1800-talscharm med skön säng, arbetsplats och snabbt
                Wi-Fi.
              </p>
              <p className="text-base leading-[1.7] text-[#4a443f]">
                Perfekt för dig som vill bo centralt i Lund, med domkyrkan och
                universitetet ett stenkast bort — men ändå landa i lugn och
                personlig service.
              </p>
            </div>
          ...
          <div className="rounded-[4px] bg-[#ebe4db] p-8 md:p-[50px]">
            ...
            >
              <div className="md:col-span-2">
                <label className={labelClass} htmlFor="er-name">Namn</label>
                <input
                  id="er-name"
                  type="text"
                  required
              ...
              <div className="md:col-span-2">
                <label className={labelClass} htmlFor="er-email">E-post</label>
                <input
                  id="er-email"
                  type="email"
                  required
              ...
              <div>
                <label className={labelClass} htmlFor="er-in">Incheckning</label>
                <input
                  id="er-in"
                  type="date"
                  required
              ...
              <div>
                <label className={labelClass} htmlFor="er-out">Utcheckning</label>
                <input
                  id="er-out"
                  type="date"
                  required
              ...
              <div>
                <label className={labelClass} htmlFor="er-phone">Telefon</label>
                <input
                  id="er-phone"
                  type="tel"
                  required
              ...
              <div>
                <label className={labelClass} htmlFor="er-discount">Rabattkod</label>
                <input
                  id="er-discount"
                  type="text"
                  value={form.discount}
